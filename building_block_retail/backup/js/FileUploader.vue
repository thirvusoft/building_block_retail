		...
		>
			<div v-if="!is_dragging">
				...
				<div class="mt-2 text-center">
					<button  v-if="allow_take_photo" class="btn btn-file-upload" @click="browse_files">
					...
					>
					<button class="btn btn-file-upload" v-if="!disable_file_browser && allow_take_photo" @click="show_file_browser = true">
						<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<button v-if="allow_take_photo" class="btn btn-file-upload" @click="show_web_link = true">
						<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<button v-if="google_drive_settings.enabled && allow_take_photo" class="btn btn-file-upload" @click="show_google_drive_picker">
