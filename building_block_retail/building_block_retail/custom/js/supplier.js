frappe.ui.form.on('TS Supplier Default Items', 'before_default_items_remove', function(frm, cdt, cdn){
        ...
        // })
        frappe.call({
            method: 'building_block_retail.building_block_retail.custom.py.supplier.remove_default_supplier_from_items',
            args:{doc:p},
            freeze:true,
...
frappe.ui.form.on("Supplier",{
    refresh: function(frm){
        frappe.call({
            method: 'building_block_retail.building_block_retail.custom.py.supplier.add_supplier_to_default_supplier_in_item',
            args:{doc:frm.doc},
        })
    },
